```javascript
{
  "compilerOptions": {
    ...
    "esModuleInterop": true,                  /* 两种模块的文件是否可以相互引用 Enables emit interoperability between CommonJS and ES Modules via creation of namespace objects for all imports. Implies 'allowSyntheticDefaultImports'. */
